...
type TrackerClient interface {
	...
	GetAllRegisteredInstances(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tracker_GetAllRegisteredInstancesClient, error)
...
func (c *trackerClient) GetAllRegisteredInstances(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tracker_GetAllRegisteredInstancesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tracker_ServiceDesc.Streams[0], "/trackerProto.Tracker/GetAllRegisteredInstances", opts...)
	if err != nil {
		return nil, err
	}
...
type TrackerServer interface {
	...
	GetAllRegisteredInstances(*emptypb.Empty, Tracker_GetAllRegisteredInstancesServer) error
...
func (UnimplementedTrackerServer) GetAllRegisteredInstances(*emptypb.Empty, Tracker_GetAllRegisteredInstancesServer) error {
