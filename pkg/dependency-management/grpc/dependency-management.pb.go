...
func (x *FileInfo) Reset() {
	*x = FileInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dependency_management_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FileInfo) Descriptor() ([]byte, []int) {
	return file_dependency_management_proto_rawDescGZIP(), []int{4}
}
...
var file_dependency_management_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x31, 0x0a, 0x0e, 0x52,
	0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a,
	0x0b, 0x72, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x72, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x55, 0x72, 0x69, 0x22, 0x60,
	...
	0x6b, 0x73, 0x75, 0x6d, 0x32, 0x8d, 0x01, 0x0a, 0x14, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65,
	0x6e, 0x63, 0x79, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x37, 0x0a,
	...
	0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x3c, 0x0a, 0x07, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76,
	0x65, 0x12, 0x14, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65,
	...
	0x28, 0x01, 0x30, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x3b, 0x67, 0x72, 0x70, 0x63, 0x62,
...
var file_dependency_management_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dependency_management_proto_goTypes = []interface{}{
	...
	(*FileInfo)(nil),        // 4: grpc.FileInfo
	(*structpb.Struct)(nil), // 5: google.protobuf.Struct
}
var file_dependency_management_proto_depIdxs = []int32{
	4, // 0: grpc.DetectRequest.file_info:type_name -> grpc.FileInfo
	5, // 1: grpc.DetectResponse.metadata:type_name -> google.protobuf.Struct
	5, // 2: grpc.ResolveResponse.metadata:type_name -> google.protobuf.Struct
	0, // 3: grpc.DependencyManagement.Detect:input_type -> grpc.DetectRequest
	2, // 4: grpc.DependencyManagement.Resolve:input_type -> grpc.ResolveRequest
	1, // 5: grpc.DependencyManagement.Detect:output_type -> grpc.DetectResponse
	3, // 6: grpc.DependencyManagement.Resolve:output_type -> grpc.ResolveResponse
...
func file_dependency_management_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dependency_management_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
